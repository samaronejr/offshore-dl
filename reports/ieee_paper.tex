...
\bottomrule
\multicolumn{6}{@{}l}{\scriptsize $^\dagger$After Optuna HPO (30 trials). DeepONet: 33 trials. All others use manually tuned hyperparameters.}
\end{tabular}
\end{table}
